...
CREATE TABLE `tasks` (
  ...
  `status` int NOT NULL DEFAULT '0' COMMENT '0: not done, 1: done',
  `priority` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '1: hight, 2: Normal, 3: Low',
  PRIMARY KEY (`id`)
...
INSERT INTO `tasks` VALUES (2,'sdf',0,'1'),(3,'test1',1,'2'),(4,'test123',0,'2');
...
-- Dump completed on 2022-02-25 11:52:20
